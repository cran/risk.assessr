...
test_that("get_exports works correctly with nonstandard NAMESPACE", {
  ...
  if (package_installed == TRUE ) {
    ...
    expect_equal(result$function_type,
                 c("regular function", "regular function, R6 class generator",
                   "regular function", "regular function, R6 class generator",
...
test_that("get_exports works correctly with R6 functions", {
  ...
  if (package_installed == TRUE ) {
    ...
    expect_equal(result$function_type, 
                 c("numeric", "S3 method", "S3 generic function", 
...
test_that("classify_function_body handles regular function", {
  ...
  expect_equal(result$function_type, "regular function")
...
test_that("classify_function_body handles S3 method with R6 class generator", {
  ...
  expect_equal(result$function_type, "regular function, R6 class generator")
...
test_that("preprocess_func_full_name works for usual S3 functions", {
  func_full_name <- "dplyr::summarise.grouped_df"
  result <- preprocess_func_full_name(func_full_name)
  expect_equal(result$package, "dplyr")
  expect_equal(result$generic, "summarise")
  expect_equal(result$class, "grouped_df")
})
...
test_that("preprocess_func_full_name works for function name without class suffix", {
  result <- preprocess_func_full_name("dplyr::mutate")
  expect_equal(result$package, "dplyr")
  expect_equal(result$generic, "mutate")
  expect_equal(result$class, "")
})
